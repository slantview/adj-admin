...
import BracketsTableRow from 'components/BracketsTableRow';
...
const BracketsListPage = (props) => {
	const siteCtx = useContext(SiteContext);
	const { loading, error, data, refetch } = useQuery(
		GET_ALL_BRACKET_FORMATS,
		{ 
	...
	return (
		<div>
            <SectionHeader 
                ...
                subtitle="Manage your tournament bracket formats."
                subtitleColor="text-white-50"
                backgroundStyle='bg-beacons-gradient'
                breadcrumbs={[
                    { title: "Home", to: "/" },
					{ title: "Tournaments", to: "/tournaments" },
                    { title: "Bracket Formats", to: null }
                ]}
            />
